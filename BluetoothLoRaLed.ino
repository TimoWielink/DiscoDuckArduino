...
//     Serial.print((char)LoRa.read());
  ...
  temp++;
     ...
     SerialBT.write(testByte, packetSize); 
//        SerialBT.write('a'); 
...
void setup() {
  Serial.begin(115200);
  setupLoRa();
  SerialBT.begin("ESP32-NNYC-2"); //Bluetooth device name
